            ...
            <div id={props.id} className="carousel slide" data-ride="carousel" data-interval={props.interval}>
                <div className="carousel-inner" role="listbox">
                    { props.images.map(function(item, index) {
                        ...
                        return (<div className={'carousel-item '+itemClass } key={index}>
                            <img className="d-block img-fluid" data-modal-picture={'#' + props.carouselModalPicture}
                                src={item.src} />
                ...
                <ol className="carousel-indicators">
                    { props.images.map(function(item, index) {
                        ...
                        return (<li data-target={'#'+props.id} data-slide-to={index} className={liClass}></li>)
                    })}
                </ol>
            </div>
        )
...
ReactDOM.render(<Carousel id="gallery-carousel" interval="3000" 
    carouselModalPicture="carousel-modal" images={carouselImages}>
</Carousel>, document.getElementById('react-gallery'));